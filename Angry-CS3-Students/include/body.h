 ...
 *
 * @param body a pointer to a image
 * @return the image associated with the body
 */
void *body_get_image(body_t *body);
...
/* 
 * Changes the color of a body
 * 
 * @param color rgb color that we want to assign to the body 
 */
